...
class BeveragesViewController: UIViewController {
    lazy var beverageView: UIView = {
        ...
        let lists = [beverageTitleLabel, sortTextField]
        for list in lists {
    ...
    func setupView() {
        let subviews = [beverageView, sortTextField, sortIcon, locationTextField, locationIcon, categoryTextField, categoryIcon]
        ...
        NSLayoutConstraint.activate([
            ...
            sortTextField.topAnchor.constraint(equalTo: beverageTitleLabel.bottomAnchor, constant: 20),
            sortTextField.leadingAnchor.constraint(equalTo: beverageView.leadingAnchor, constant: 20),
            ...
            locationTextField.topAnchor.constraint(equalTo: beverageTitleLabel.bottomAnchor, constant: 20),
            ...
            categoryTextField.topAnchor.constraint(equalTo: beverageTitleLabel.bottomAnchor, constant: 20),
