...
class HomeCareViewController: UIViewController {
    ...
    func setupView() {
        let subviews = [homeCareView, sortTextField, sortIcon, locationTextField, locationIcon, categoryTextField, categoryIcon]
        ...
        NSLayoutConstraint.activate([
            ...
            sortTextField.topAnchor.constraint(equalTo: homeCareTitleLabel.bottomAnchor, constant: 20),
            sortTextField.leadingAnchor.constraint(equalTo: homeCareView.leadingAnchor, constant: 20),
            ...
            locationTextField.topAnchor.constraint(equalTo: homeCareTitleLabel.bottomAnchor, constant: 20),
            ...
            categoryTextField.topAnchor.constraint(equalTo: homeCareTitleLabel.bottomAnchor, constant: 20),
